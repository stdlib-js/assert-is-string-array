...
```javascript
import isStringArray from 'https://cdn.jsdelivr.net/gh/stdlib-js/assert-is-string-array@v0.1.0-deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { objects, primitives } from 'https://cdn.jsdelivr.net/gh/stdlib-js/assert-is-string-array@v0.1.0-deno/mod.js';
```
